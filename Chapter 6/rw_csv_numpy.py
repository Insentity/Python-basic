infile = open('C:\\CongLuan\\Courses\\Python basics\\Exercises\\Python-basic\\Chapter 6\\budget.csv', 'r')
import csv
...
outfile = open('C:\\CongLuan\\Courses\\Python basics\\Exercises\\Python-basic\\Chapter 6\\budget2.csv', 'w')
