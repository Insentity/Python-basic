...
def toStringFunction4(test):
    from scitools import StringFunction
    return StringFunction.StringFunction(test, independent_variable='p')
    # return StringFunction('p', independent_variable='p')
